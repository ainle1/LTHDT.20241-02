    ...
    public boolean tieuthu() {
        ...
        if (this.energy < 150) {
            ...
            if (mucTieu != null) {
                ...
                // Loại bỏ SinhVatSanXuat khỏi hệ sinh thái
                ...
                int energyIncrease = (int) (this.energy * 0.1);  // Cộng 10% năng lượng hiện tại
                ...
                // Cập nhật vị trí sinh vật AnCo sau khi tiêu thụ
                this.x = xMucTieu;
                this.y = yMucTieu;

                // Đặt lại sinh vật AnCo vào vị trí của SinhVatSanXuat
                O oSinhVatAnCo = heSinhThai.getO(this.x, this.y);
